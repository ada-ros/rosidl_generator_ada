...
package rcutils_rcutils_types_hash_map_h is

   --  arg-macro: procedure HASH_MAP_VALIDATE_HASH_MAP (map)
   --    RCUTILS_CHECK_ARGUMENT_FOR_NULL(map, RCUTILS_RET_INVALID_ARGUMENT); if (NULL = map.impl) { RCUTILS_SET_ERROR_MSG("map is not initialized"); return RCUTILS_RET_NOT_INITIALIZED; }
  ...
  --/ \file
   type rcutils_hash_map_impl_s is null record;   -- incomplete struct

  --/ The structure holding the metadata for a hash map.
  --/ A pointer to the PIMPL implementation type.
   type rcutils_hash_map_s is record
      impl : access rcutils_hash_map_impl_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:38
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:35

   subtype rcutils_hash_map_t is rcutils_hash_map_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:39
  ...
  --  
   ...
   type rcutils_hash_map_key_hasher_t is access function (arg1 : System.Address) return stddef_h.size_t
   with Convention => C;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:46
  ...
  --  
   ...
   type rcutils_hash_map_key_cmp_t is access function (arg1 : System.Address; arg2 : System.Address) return int
   with Convention => C;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:58
  ...
  --  
   ...
   function rcutils_hash_map_string_hash_func (key_str : System.Address) return stddef_h.size_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:83
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_string_hash_func";
  ...
  --  
   ...
   function rcutils_hash_map_string_cmp_func (val1 : System.Address; val2 : System.Address) return int  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:92
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_string_cmp_func";
  ...
  -- *  
   ...
   function rcutils_get_zero_initialized_hash_map return rcutils_hash_map_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:122
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_get_zero_initialized_hash_map";
  ...
  --  
   ...
   function rcutils_hash_map_init
     (hash_map : access rcutils_hash_map_t;
      initial_capacity : stddef_h.size_t;
      key_size : stddef_h.size_t;
      data_size : stddef_h.size_t;
      key_hashing_func : rcutils_hash_map_key_hasher_t;
      key_cmp_func : rcutils_hash_map_key_cmp_t;
      allocator : access constant rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:175
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_init";
  ...
  --  
   ...
   function rcutils_hash_map_fini (hash_map : access rcutils_hash_map_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:205
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_fini";
  ...
  --  
   ...
   function rcutils_hash_map_get_capacity (hash_map : access constant rcutils_hash_map_t; capacity : access stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:234
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_get_capacity";
  ...
  --  
   ...
   function rcutils_hash_map_get_size (hash_map : access constant rcutils_hash_map_t; size : access stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:260
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_get_size";
  ...
  --  
   ...
   function rcutils_hash_map_set
     (hash_map : access rcutils_hash_map_t;
      key : System.Address;
      value : System.Address) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:288
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_set";
  ...
  --  
   ...
   function rcutils_hash_map_unset (hash_map : access rcutils_hash_map_t; key : System.Address) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:315
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_unset";
  ...
  --  
   ...
   function rcutils_hash_map_key_exists (hash_map : access constant rcutils_hash_map_t; key : System.Address) return Extensions.bool  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:340
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_key_exists";
  ...
  --  
   ...
   function rcutils_hash_map_get
     (hash_map : access constant rcutils_hash_map_t;
      key : System.Address;
      data : System.Address) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:367
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_get";
  ...
  --  
   ...
   function rcutils_hash_map_get_next_key_and_data
     (hash_map : access constant rcutils_hash_map_t;
      previous_key : System.Address;
      key : System.Address;
      data : System.Address) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/hash_map.h:416
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_hash_map_get_next_key_and_data";

end rcutils_rcutils_types_hash_map_h;
