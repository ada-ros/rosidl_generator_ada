...
package rosidl_runtime_c_rosidl_runtime_c_sequence_bound_h is
  ...
  -- limitations under the License.
   ...
   with Convention => C;  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:28

  --/ String identifier for the type_support.
   type rosidl_runtime_c_u_Sequence_u_bound is record
      typesupport_identifier : Interfaces.C.Strings.chars_ptr;  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:34
      data : System.Address;  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:36
      func : rosidl_runtime_c_u_bound_handle_function;  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:37
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:31
  ...
  --  
   ...
   function get_sequence_bound_handle (handle : access constant rosidl_runtime_c_u_Sequence_u_bound; identifier : Interfaces.C.Strings.chars_ptr) return access constant rosidl_runtime_c_u_Sequence_u_bound  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:50
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function get_sequence_bound_handle_function (handle : access constant rosidl_runtime_c_u_Sequence_u_bound; identifier : Interfaces.C.Strings.chars_ptr) return access constant rosidl_runtime_c_u_Sequence_u_bound  -- /opt/ros/jazzy/include/rosidl_runtime_c/rosidl_runtime_c/sequence_bound.h:64
   with Import => True, 
        Convention => C, 
...
end rosidl_runtime_c_rosidl_runtime_c_sequence_bound_h;
